...
<!-- <html <?php language_attributes(); ?> ng-app="omahabeerweek"> -->
<!--<![endif]-->
<head>
	...
	<!--[if lt IE 9]>
	<script src="<?php echo $template_directory_uri ?>/js/lib/html5.js" type="text/javascript"></script>
	<![endif]-->
	<?php wp_head(); ?>

	<script type="text/javascript">
		var ROOT = '<?php bloginfo('url'); ?>/',
			THEME_ROOT = '<?php echo $template_directory_uri ?>/';
	</script>
